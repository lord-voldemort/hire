...
set :application, "hire-app"
set :repository,  "git@github.com:flatiron-school/hire.git"
...
role :web, "198.211.116.12"                          # Your HTTP server, Apache/etc
role :app, "198.211.116.12"                          # This may be the same as your `Web` server
role :db,  "198.211.116.12", :primary => true # This is where Rails migrations will run
